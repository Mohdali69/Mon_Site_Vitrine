...
--
-- Client :  localhost
-- Généré le :  Ven 14 Septembre 2018 à 11:30
...
INSERT INTO `employe` (`id_employe`, `nom_employe`, `prenom`, `date_naissance`, `date_arrivee`) VALUES
...
INSERT INTO `Module` (`Code`, `Nom`, `Coefficient`) VALUES
('UE11', 'Base de l''Informatique', 17),
('UE12', 'Culture scientifique, sociale et humaine', 13),
('UE21', 'Approfondissements en Informatique', 16),
('UE22', 'Culture scientifique, sociale et humaine', 14);
...
(11, 'DSC11.jpg', 'la photo du koala', 1);
...
INSERT INTO `reponses` (`id`, `id_sondage`, `texte`, `nbChoisi`) VALUES
(1, 1, 'Super', 6),
(2, 1, 'Moyen', 9),
(3, 1, 'Nul', 5),
(4, 2, 'PHP', 2),
...
INSERT INTO `sondages` (`id`, `question`, `nbConsult`) VALUES
(1, 'Que pensez vous de ce site ?', 0),
(2, 'Quel est votre langage préféré ?', 0),
(3, 'Quelle est votre couleur préférée', 0);
...
--
ALTER TABLE `exerce`
  ADD PRIMARY KEY (`id_employe`,`id_metier`,`id_service`),
...
--
ALTER TABLE `metier`
  MODIFY `id_metier` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=18;
--
...
--
ALTER TABLE `exerce`
  ADD CONSTRAINT `exerce_ibfk_1` FOREIGN KEY (`id_employe`) REFERENCES `employe` (`id_employe`),
  ADD CONSTRAINT `exerce_ibfk_2` FOREIGN KEY (`id_metier`) REFERENCES `metier` (`id_metier`),
  ADD CONSTRAINT `exerce_ibfk_3` FOREIGN KEY (`id_service`) REFERENCES `service` (`id_service`);
